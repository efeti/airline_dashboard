      ...
      <div class="col-md-12">
        <div class="card-table">
          ...
          <div class="col-md-8 m-3">
            <a href="#!" data-id="" data-bs-toggle="modal" data-bs-target="#addairplanemodal" class="btn btn-primary btn-sm">Add Airplane</a>

          </div>
          <div class="card-body">
            <div class="table-responsive">
              <table id="airplane" class="table data-table" style="width:100%">
                <thead>
                  <tr>
                    <th>id</th>
                    <th>company</th>
